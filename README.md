...
> Mega generate random names/usernames/passwords

[![PyPI version](https://badge.fury.io/py/mega-random-name.svg)](https://pypi.org/project/mega-random-name/)
...
```bash
pip install mega-random-name
```

## Quick Start

```python
from mega_random_name import name
...
from mega_random_name import batch
